...
CREATE TABLE JOVEN_NIÑO (ID BIGINT NOT NULL, APELLIDO1 VARCHAR(255) NOT NULL, APELLIDO2 VARCHAR(255), DESCRIPCION VARCHAR(255), FECHANACIMIENTO DATE, NACIONALIDAD VARCHAR(255) NOT NULL, NOMBRE VARCHAR(255) NOT NULL, CCJ_ID BIGINT, CP_ID BIGINT, PRIMARY KEY (ID))
